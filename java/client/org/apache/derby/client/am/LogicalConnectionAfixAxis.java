...
public class LogicalConnectionAfixAxis implements java.sql.Connection {
    ...
    public LogicalConnectionAfixAxis(Connection physicalConnection,
    ...
    synchronized public void nullPhysicalConnection() {
    	synchronized (LogicalCallableStatement.class) {
