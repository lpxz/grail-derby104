...
final class GenericActivationHolder implements Activation
{
	...
	public ResultSet execute() throws StandardException
	{
		...
		*/
		// synchronized (ps)
		{
			// lpxz, when evaluating derby5561, comment the following code, which are relocated purposely.
//			 synchronized(ps){ // original.
//			// synchronized (GenericActivationHolder.class) 
//			 { //lpxz, my tricks for measuring the performance. the execution does not enter the branch, too bad!
